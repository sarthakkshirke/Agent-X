...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="h-[93vh] w-full relative overflow-hidden">
      <div className="relative flex flex-col items-center w-full h-full px-6">
        ...
        <div className="relative z-10 max-w-3xl mx-auto h-full w-full flex flex-col gap-10 items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center gap-5">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-medium tracking-tighter text-balance text-center">
              <span className="text-secondary">AgentX</span><span className="text-primary">, your AI Employee.</span>
            </h1>
        ...
        <DialogContent className="sm:max-w-md rounded-xl bg-[#F3F4F6] dark:bg-[#F9FAFB]/[0.02] border border-border">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Sign in or create an account to talk with AgentX
            </DialogDescription>
          </DialogHeader>
